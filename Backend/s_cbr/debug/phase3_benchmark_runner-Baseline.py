...
class BenchmarkConfig:
    ...
    OUTPUT_CSV = "test_results/thesis_experiment_data-Baseline.csv"
    OUTPUT_REPORT = "test_results/phase3_summary_report-Baseline.txt"
    
    # 實驗標籤 (每次執行前請修改此處以區分實驗組/對照組)
    # 例如: "Agentic_V1.5" 或 "Baseline_Traditional"
    EXPERIMENT_TAG = "Baseline_Spiral" 
